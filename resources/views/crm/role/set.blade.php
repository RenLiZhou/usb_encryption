            ...
            <div class="layui-field-box">
                <form class="layui-form layui-form-pane">
                    ...
                    <div class="layui-form-item text-center">
                        @crm_permission('crm.role.rule.set')
                        <button type="button" data-url="{{ route('crm.role.rule.set', ['role' => $role->id]) }}" data-type="PATCH" class="layui-btn" lay-submit type="button" lay-filter="set">提交</button>
                        @endcrm_permission
                    </div>
                </form>
            </div>
