    ...
    <main class="ftdms-layout-content">
        <div class="container-fluid">
            <div class="row mt15 mb60">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header"><h4>新建更新策略 | <a class="text-cyan" href="javascript:;" onclick="_jM.dialogCloseCurIf()">返回列表</a></h4></div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="row" id="formsubmit">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="name" value="" placeholder="请输入更新策略名称"/>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="example-box">
                                        <label class="ftdms-checkbox checkbox-primary m-t-10">
                                            <input type="checkbox" name="hint" value="1"><span>U盘运行后自动提示更新文件</span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="example-box">
                                        ...
                                        <div>
                                            <label class="ftdms-radio radio-primary mt15 pull-left">
                                                <input type="radio" name="valid_type" value="3"><span>指定日期</span>
                                            </label>
                                ...
                                <div class="form-group col-md-12 text-center">
                                    <button type="button" class="btn btn-primary" data-url="{{ route('merchant.strategy_update.store') }}" data-type="POST" onClick="TObj.submit(this)">确定</button>
