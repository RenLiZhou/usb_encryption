...
@section("title")
    <title>{{ __('merchant_view.new_update_strategy') }}</title>
@endsection
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>
                                {{ __('merchant_view.new_update_strategy') }} |
                        ...
                        <div class="card-body">
                            ...
                            <form class="row" id="formsubmit">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="title">{{ __('merchant_view.update_policy_name') }}</label>
                                    <input type="text" class="form-control" name="name" value=""
                                           placeholder="{{ __('merchant_view.please_enter_the_update_policy_name') }}"/>
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="title">{{ __('merchant_view.automatic_update_prompt') }}</label>
                                    <div class="example-box">
                                        <label class="ftdms-checkbox checkbox-primary m-t-10">
                                            <input type="checkbox" name="hint" value="1"><span>
                                                {{ __('merchant_view.automatically_prompt_to_update_files_after_the_u_disk_is_running') }}
                                            </span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="example-box">
                                        ...
                                        <div>
                                            <label class="ftdms-radio radio-primary mt15 pull-left">
                                                <input type="radio" name="valid_type" value="3">
                                                <span>{{ __('merchant_view.specified_date') }}</span>
                                            </label>
                                            <span class="col-sm-2 ml15">
                                                <div class="input-group m-t-5">
                                                    <input type="text" class="form-control form_datetime" disabled name="valid_time" aria-label="..." />
                                ...
                                <div class="form-group col-md-12 mt15">
                                    <div>
                                        <label>
                                            {{ __('merchant_view.select_file_the_file_library') }}
                                        </label>
                                ...
                                <div class="form-group col-md-12 text-center">
                                    <button type="button" class="btn btn-primary" data-url="{{ route('merchant.strategy_update.store') }}" data-type="POST" onClick="TObj.submit(this)">
                                        {{ __('common.ok') }}
                                    </button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">
                            {{ __('merchant_view.strategy_update_close') }}
                        </button>
                        <button type="button" class="btn btn-primary" onclick="TObj.addFile()">
                            {{ __('merchant_view.confirm_selection') }}
                        </button>
                    </div>
                </div>
            </div>
