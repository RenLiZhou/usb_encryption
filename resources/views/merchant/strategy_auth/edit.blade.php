                        ...
                        <div class="card-body">
                            ...
                            <form class="row" id="formsubmit">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ $data->name }}" placeholder="请输入权限策略名称"/>
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="title">运行次数(-1表示永久)</label>
                                    <input type="number" class="form-control" name="run_number" value="{{ $data->run_number }}" placeholder="请输入运行次数"/>
                                </div>
                                ...
                                <div class="form-group col-md-12 clearfix">
                                    ...
                                    <div class="example-box">
                                        <label class="ftdms-radio radio-primary mt15 clearfix">
                                            <input type="radio" name="expired_type" value="0" @if($data->expired_type == 0) checked @endif><span>永久有效</span>
                                        </label>
                                        ...
                                        <div class="clearfix">
                                            <label class="ftdms-radio radio-primary mt20 pull-left">
                                                <input type="radio" name="expired_type" value="2" @if($data->expired_type == 2) checked @endif><span>固定日期</span>
                                            </label>
                                ...
                                <div class="form-group col-md-12 text-center mt35">
                                    <button type="button" class="btn btn-primary" data-url="{{ route('merchant.strategy_auth.update',['strategy_auth' => $data->id]) }}" data-type="PATCH" onClick="TObj.submit(this)">确定</button>
